...
namespace DentalCare.Controllers
{
    ...
    {
        private readonly DentalCareOrtContext _context;

        public ReservasController(DentalCareOrtContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Reservas != null ? 
                          ...
                          Problem("Entity set 'DentalCareOrtContext.Reservas'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DentalCareOrtContext.Reservas'  is null.");
            }
            var reserva = await _context.Reservas.FindAsync(id);
            if (reserva != null)
            {
